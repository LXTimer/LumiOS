...
// ─────────────────────────────────────────────
const APPS = [
  { id:'welcome',    name:'Welcome',    ic:'ti-sparkles',  gr:'linear-gradient(135deg,#9333ea,#e11d9c)', w:550, h:572 },
...
const WALLPAPERS = [
  {
    id: 'default',
    label: 'Anime 1',
    css: `url('assets/wallpaper/anime/wallpaper_anime_1.jpg') center/cover no-repeat`,
  },
  {
    id: 'midnight',
    label: 'Midnight',
  ...
  {
    id: 'wallpaper_anime_2',
    label: 'Anime 2',
    css: `url('assets/wallpaper/anime/wallpaper_anime_2.png') center/cover no-repeat`,
  },
  {
    id: 'wallpaper_anime_3',
    label: 'Anime 3',
    css: `url('assets/wallpaper/anime/wallpaper_anime_3.jpg') center/cover no-repeat`,
  },
];
